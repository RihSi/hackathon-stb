...
<template>
  <header>
    <v-app-bar app dark dense flat>
      <v-toolbar-title>
        <span class="mx-1">
          <v-icon x-large class="amber--text">
      ...
      <v-spacer />
      <v-btn class="amber--text" :to="{ name: 'hall' }" icon rounded x-large>
      ...
      >
        ...
        <v-icon class="white--text" x-large v-else> mdi-chevron-down </v-icon>
      </v-btn>
    </v-app-bar>
    <v-card
      class="mx-auto"
      ...
      "
    >
      <v-img contain :src="require('../assets/jackpot.png')">
        <vns
          class="jackpot-value font-weight-bold white--text text-right"
          style="
...
export default {
  ...
  props: ["seatData", "account", "currency", "funds"],
};
</script>
